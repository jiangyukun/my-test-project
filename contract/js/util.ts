...
export function getTokenDisplay(d, precision = 2, tokenLength = 18) {
  if (!d) {
    return null
  }
  if (typeof d == 'string') {
...
export function createRequestManage(limit) {
  let currentTotal = 0
  let todoList = []
  return {
    schedule(callback) {
...
export function listTaskWithRetry(label, list, options, level = 1) {
