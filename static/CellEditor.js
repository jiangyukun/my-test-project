...
class CellEditor extends mxCellEditor {
  ...
  installListeners(elt) {
      super.installListeners(...arguments);
  ...
  getInitialValue(state, trigger) {
      ...
      {
          return super.getInitialValue(...arguments);
      }
      else
      {
  ...
  getCurrentValue(state) {
      if (mxUtils.getValue(state.style, 'html', '0') == '0')
      {
          return super.getCurrentValue(...arguments);
      }
      else
      {
